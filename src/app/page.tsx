  ...
  return (
    <div className="flex flex-col justify-center">
      <div className="flex items-center  mt-4 justify-between mx-2">
        ...
        <Button onClick={()=>signIn("google",{callbackUrl:"/sign-in", redirect: true})}>Sign In</Button>
      </div>
      ...
      <Button className="w-fit mt-12 place-self-center">Get started, Its free</Button>
